...
Asset discovery - `subfinder -d target.com -silent | httprobe > domains.txt`
URL extraction - `cat domains.txt | katana | tee urls.txt
Smart grep - We combine:
...
subfinder -> shuffledns (to verify subdomains)

## Port scanning to findings
